...
INSERT INTO requests (hospital_id, required_blood_type, required_organ_type, status) VALUES
  ('f1e2d3c4-b5a6-9788-1234-567890abcdef', 'O+', null, 'urgent'),
  ('f1e2d3c4-b5a6-9788-1234-567890abcdef', null, 'Kidney', 'pending'),
  ('a9b8c7d6-e5f4-3210-9876-fedcba098765', 'A+', null, 'urgent'),
  ('a9b8c7d6-e5f4-3210-9876-fedcba098765', null, 'Heart', 'critical'),
  ('1a2b3c4d-5e6f-7890-abcd-ef1234567890', 'B+', null, 'pending'),
  ('1a2b3c4d-5e6f-7890-abcd-ef1234567890', null, 'Liver', 'urgent');
